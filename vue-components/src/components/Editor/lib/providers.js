...
export class SimpleLanguageInfoProvider {
  ...
  getTokensProviderForLanguage(language) {
    ...
    const encodedLanguageId = this.monaco.languages.getEncodedLanguageId(
      language
    );
...
function createStyleElementForColorsCSS() {
  ...
  if (monacoColors) {
    (_a = monacoColors.parentElement) === null || _a === void 0
      ? void 0
      : _a.insertBefore(style, monacoColors.nextSibling);
  } else {
