((typeof self !== 'undefined' ? self : this)["webpackJsonppeacock_trame"] = (typeof self !== 'undefined' ? self : this)["webpackJsonppeacock_trame"] || []).push([[6],{
...
var languageFeatures_DiagnosticsAdapter = /** @class */ (function () {
    function DiagnosticsAdapter(_languageId, _worker, defaults) {
        ...
        var onModelRemoved = function (model) {
            monaco_editor_core["editor"].setModelMarkers(model, _this._languageId, []);
        ...
        this._disposables.push(monaco_editor_core["editor"].onDidCreateModel(onModelAdd));
        this._disposables.push(monaco_editor_core["editor"].onWillDisposeModel(function (model) {
            onModelRemoved(model);
            _this._resetSchema(model.uri);
        }));
        this._disposables.push(monaco_editor_core["editor"].onDidChangeModelLanguage(function (event) {
            onModelRemoved(event.model);
            onModelAdd(event.model);
            _this._resetSchema(event.model.uri);
        }));
        this._disposables.push(defaults.onDidChange(function (_) {
            monaco_editor_core["editor"].getModels().forEach(function (model) {
        ...
        this._disposables.push({
            dispose: function () {
                monaco_editor_core["editor"].getModels().forEach(onModelRemoved);
    ...
    DiagnosticsAdapter.prototype._doValidate = function (resource, languageId) {
        this._worker(resource)
            ...
            return worker.doValidation(resource.toString()).then(function (diagnostics) {
                ...
                var model = monaco_editor_core["editor"].getModel(resource);
                if (model && model.getLanguageId() === languageId) {
                    monaco_editor_core["editor"].setModelMarkers(model, languageId, markers);
                }
            });
        })
...
function toLocation(location) {
    return {
        uri: monaco_editor_core["Uri"].parse(location.uri),
...
function setupMode(defaults) {
    ...
    function registerProviders() {
        ...
        if (modeConfiguration.tokens) {
            providers.push(monaco_editor_core["languages"].setTokensProvider(languageId, createTokenizationSupport(true)));
        }
        if (modeConfiguration.colors) {
            providers.push(monaco_editor_core["languages"].registerColorProvider(languageId, new DocumentColorAdapter(worker)));
        }
    ...
    registerProviders();
    disposables.push(monaco_editor_core["languages"].setLanguageConfiguration(defaults.languageId, richEditConfiguration));
...
//# sourceMappingURL=vue-peacock_trame.umd.6.js.map